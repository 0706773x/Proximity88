...
namespace TFGProximity.Core.ViewModels
{
	public class DemoPageViewModel : BindableBase
	{
		...
		public DemoPageViewModel (IBeaconRanger beaconRanger, INavigationService navigationService, IEventAggregator eventAggregator)
		{
		...
		/*public virtual void OnNavigatedTo (NavigationParameters parameters)
		{
			...
			param.Add ("url", "http://intervatebeacons.azurewebsites.net/content/media/bag2.jpg");
			param.Add ("title", "Louis Vuitton");

			NavigationService.NavigateAsync ("RootPage/WebViewPage", param, true);
		}*/
		...
		private async Task ShowWebView (BeaconViewModel beacon, string title = "TFG Store Of The Future")
		{
